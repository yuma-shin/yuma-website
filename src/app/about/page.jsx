        ...
        <div className="lg:pl-20">
          <div className="max-w-xs px-2.5 lg:max-w-none">
            <Image
              ...
              className="aspect-square rotate-3 rounded-2xl bg-zinc-100 object-cover shadow-md dark:bg-zinc-800"
            />
          </div>
        </div>
        <div className="lg:order-first lg:row-span-2">
          ...
          <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
            <div>
              ...
              <p className="mt-2">
                プロフィール画像は友達に10秒ほどで描いてもらった僕の似顔絵ですw
              </p>
            </div>
            <div>
              <h1 className="text-4xl tracking-tight text-zinc-800 sm:text-4xl dark:text-zinc-100">
                高専
              </h1>
              <p className="mt-2">
                高専時代は5年間、宇宙開発研究部に所属し気象観測機器の開発やBalloon
                Sat・Cube Satの開発をやっていました。
                卒業研究ではバルーンサットの開発とCubeSat教材への改良の検討をやっていました。
              </p>
              <p className="mt-2">
                宇宙開発研究部ではRaspberry
                PiやArduinoを用いたセンサ機器の開発や、測定した情報を提供するためのWEBサイトの開発を担当していました。
            ...
            <div>
              ...
              <p className="mt-2">
                最近では生成AIの活用推進も担当しており、主にAzure
                OpenAIを活用したカイゼン企画、アプリケーションの開発に取り組んでいます。
              </p>
            </div>
            <div>
              <h1 className="text-4xl tracking-tight text-zinc-800 sm:text-4xl dark:text-zinc-100">
