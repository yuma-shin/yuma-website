      ...
      <div className="space-y-20">
        <ToolsSection title="Workstation">
          <Tool title="Custom PC (Core i7 11700k, RTX 3080, 32GB RAM)">
            第11世代Core i7とRTX
            3080をベースとした自作PCをプライベートの開発用で使用しています。
            <br />
            開発用とは名ばかりでゲームばかりしていますが...w
          </Tool>
          <Tool title="13' MacBook Air, M2, 8GB RAM (2022)">
            サブPCとしてM2 Mac
            BookAirを使用しています。軽い開発やネットサーフィンに使用しています。
            <br />
            初めてのMacで最近購入しました。WindowsとMacは両方使いこなせるようになりたいですね。
          </Tool>
          <Tool title="13.3' Lenovo IdeaPad Slim 5 Light Gen 10, AMD Ryzen™ 7 7735HS, 16GB RAM (2024)">
          ...
          <Tool title="Logicool MX Master 3">
            ...
            <br />
            ちなみにMXシリーズではMX Keys(キーボード), MX Master 2s, MX Master
            3sを持っています。
            <br />
        ...
        <ToolsSection title="Development tools">
          ...
          <Tool title="Terminal">
            コマンド実行はWindowsに標準搭載されているターミナルをOh My
            Poshでカスタマイズして使用しています。
          </Tool>
        </ToolsSection>
      </div>
    </SimpleLayout>
